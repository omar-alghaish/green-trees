...
export const Right = ({setpay_type,setorder_time,setdelivary_type,delivary_type,setActiveLocation,activeLocation,cardInfo,setCardInfo,userOrderInfo,setUserOrderInfo,setchoose_subs,choose_subs}) => {
          ...
          <div className="content">
            <div className="d-flex">
              ...
              <input style={{
                ...
                borderRadius:'4px',
                flex:'1'
              }} disabled={diableInputs} type="text" value={userOrderInfo&&userOrderInfo?.name} />
            </div>
            <div className="d-flex">
              <strong>الرقم: </strong>
              <input style={{
        ...
        <div className="row">
          ...
          <div className="content">
            <div className="checkBox-container">
              <label onClick={()=>{
                setdelivary_type(delivary_type=='quickly'?'':'quickly')
              }} class="checkBox">
            ...
            <label htmlFor="date" style={{cursor:'pointer'}} className="d-flex">
