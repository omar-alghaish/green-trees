      ...
      {options&&options.length>0&&options?.map((item) => (
        ...
        {console.log(item)}
          <div className="product-image">
            ...
            <img style={{maxWidth:'100%'}} src={item.images&&item.images[0].url.includes('.')?item.product.images[0].url:require("../../assets/images/no_image.png")} alt="Product" />
          </div>
          <div className="product-details">
            <h2>{language=='ar'?item.title_ar:item.title_en}</h2>
